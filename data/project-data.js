...
export default [
    {
        ...
        imgSrc: "/project_imgs/concertPortfolio.png",
        desc: "Over the years, I have built a collective of images and videos that I have taken at concerts. As a result, I believe that it would be best to showcase the moments that I have captured. Here, I have created a photography portfolio that can be navigated through each concert or event. When you are located on that specific page, you can view the images through a slide show, along with a description of that event. ",
        stack: ["React", "Node.js", "CSS"],
        demo: "https://johnclimie.github.io/concertportfolio/",
        src: "https://github.com/johnclimie/concertportfolio"
    },
    {
